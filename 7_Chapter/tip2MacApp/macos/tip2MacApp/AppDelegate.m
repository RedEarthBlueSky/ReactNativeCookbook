...
-(id)init
{
  if(self = [super init]) {
    ...
    [windowController setWindowFrameAutosaveName:@"tip2MacApp"];
...
- (void)setUpApplicationMenu
{
  ...
  [rootMenu addItemWithTitle:@"Quit tip2MacApp" action:@selector(terminate:) keyEquivalent:@"q"];
